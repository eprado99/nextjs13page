...
the reason for this was that their **current CRM platform was really old and not user friendly with poor UX and UI**, often needing to go through multiple pages to enter the data for each student.
...
and update the Google Sheets row with the attendance data once the QR code was scanned. This allowed the NGO to **track attendance in real time** and **automate the process of logging the data into their CRM**.
